...
public class TanksGame extends Applet implements Runnable, KeyListener, MouseListener, MouseMotionListener {
    ...
    private Weapon machineGun, shotGun, sniperGun, doubleGun, waveGun;
    private Image image, character, background, cursor, enemyTank, playerBullet;
	...
	character = getImage(base, "../data/playerTank.png");
        ...
        waveGun = new Weapon(10, 0.1, 40, 5, 200, 20, 16);
