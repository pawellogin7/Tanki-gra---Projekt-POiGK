...
public class Weapon {
    ...
    //Both primary and secondary weapons are members of this class
    //You have to have at least one primary weapon equipped on each tank
    ...
    //Returning projectile with current weapon stats (damage etc.) when weapon was shot
    //and projectile was created
